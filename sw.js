const CACHE='tanko-v10-professional';
const CORE=['./','./index.html','./styles.css','./app.js','./config.js','./manifest.webmanifest','./reset-password.html','./icons/icon-192.png','./icons/icon-512.png'];
